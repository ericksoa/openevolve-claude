...
/// Gen12: Recency 36% with window 140
/// Base: gen11_window_140 (+4.46% TEST)
/// Hypothesis: Slightly higher recency with optimal window
...
impl EvictionScorer for Evolved {
    fn score(&self, token: &TokenInfo) -> f64 {
        ...
        // Slightly reduced attention to compensate
