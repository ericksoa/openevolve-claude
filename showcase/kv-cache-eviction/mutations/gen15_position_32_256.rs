...
/// Gen15: Position power 0.32 with window 256
/// Base: gen14_window_256 (+5.91% TEST)
/// Hypothesis: Fine-tune position power from 0.3 to 0.32
...
impl EvictionScorer for Evolved {
    fn score(&self, token: &TokenInfo) -> f64 {
        ...
        // Position power 0.32 (increased from 0.3)
        let position_factor = (token.position as f64 / token.sequence_len as f64).powf(0.32);
