...
/// Gen17: Stronger layer adaptation 0.07 with window 440
/// Base: gen16_window_440 (+6.48% TEST)
/// Hypothesis: More aggressive layer-adaptive attention
...
impl EvictionScorer for Evolved {
    fn score(&self, token: &TokenInfo) -> f64 {
        ...
        // Stronger layer adaptation (0.07 vs 0.05)
        let recent_weight = 0.24 - 0.07 * layer_ratio;
        let cumulative_weight = 0.13 + 0.07 * layer_ratio;
