...
/// Gen11: Layer-adaptive position power
/// Base: gen10_cross_position (+2.86% TRAIN)
/// Hypothesis: Position correction may need to vary by layer
...
impl EvictionScorer for Evolved {
    fn score(&self, token: &TokenInfo) -> f64 {
        ...
        let position_power = 0.25 + 0.10 * layer_ratio;
