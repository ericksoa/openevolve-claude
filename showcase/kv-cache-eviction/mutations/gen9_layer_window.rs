...
/// Gen9: Layer-adaptive window size
...
impl EvictionScorer for Evolved {
    fn score(&self, token: &TokenInfo) -> f64 {
        ...
        // Layer-adaptive window: early layers need more context
        // Early layers: 160, Late layers: 96
        let recency_window = (160.0 - 64.0 * layer_ratio) as usize;
