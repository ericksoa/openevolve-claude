...
/// Gen10: High recency weight (40% vs 35%)
/// Base: gen9_recency_35 (+2.65% over hybrid)
/// Hypothesis: Test if higher recency continues to improve
...
impl EvictionScorer for Evolved {
    fn score(&self, token: &TokenInfo) -> f64 {
        ...
        // Reduced attention (32%)
        let recent_weight = 0.20 - 0.05 * layer_ratio;
        let cumulative_weight = 0.12 + 0.05 * layer_ratio;
