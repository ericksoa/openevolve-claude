...
/// Gen8: Even larger recency window (112 vs 96)
/// Base: gen7_window_96 (+1.84% over hybrid)
/// Hypothesis: Continue the trend - larger windows capture more context
...
impl EvictionScorer for Evolved {
    fn score(&self, token: &TokenInfo) -> f64 {
        ...
        // Larger window: 112 vs 96
        let recency_window = 112;
