...
/// Gen8: Boost recency weight with larger window
/// Base: gen7_window_96 (+1.84% over hybrid)
/// Hypothesis: Larger window deserves more weight (35% vs 30%)
...
impl EvictionScorer for Evolved {
    fn score(&self, token: &TokenInfo) -> f64 {
        ...
        // Slightly reduced attention to make room for recency
        ...
        // Boosted recency: 35% vs 30%, window 96
