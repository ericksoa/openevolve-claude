...
/// Gen11: Stronger norm penalty 0.16
/// Base: gen10_cross_position (+2.86% TRAIN)
/// Hypothesis: Stronger norm penalty may help identify outliers
...
impl EvictionScorer for Evolved {
    fn score(&self, token: &TokenInfo) -> f64 {
        ...
        // Slightly reduced attention to compensate for higher norm
        ...
        // Stronger norm penalty 0.16 (vs 0.14 in champion)
