...
/// Gen15: Recency 36% with window 256
/// Base: gen14_window_256 (+5.91% TEST)
/// Hypothesis: Increase recency weight with optimal window
...
impl EvictionScorer for Evolved {
    fn score(&self, token: &TokenInfo) -> f64 {
        ...
        // Slightly reduced attention for higher recency
