...
/// Gen15: Stronger layer adaptation with window 256
/// Base: gen14_window_256 (+5.91% TEST)
/// Hypothesis: More aggressive layer-adaptive attention weights
...
impl EvictionScorer for Evolved {
    fn score(&self, token: &TokenInfo) -> f64 {
        ...
        // Stronger layer adaptation (0.06 vs 0.05)
