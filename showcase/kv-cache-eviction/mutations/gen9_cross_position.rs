...
/// Gen9: Combine window_128 with stronger position correction
/// Base: gen8_window_128 + gen8_cross_position idea
/// Hypothesis: Best window + best position correction
...
impl EvictionScorer for Evolved {
    fn score(&self, token: &TokenInfo) -> f64 {
        ...
        // Stronger position correction (0.3 vs 0.2)
