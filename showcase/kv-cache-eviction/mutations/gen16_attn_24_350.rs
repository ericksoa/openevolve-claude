...
/// Gen16: Stronger attention weight with window 350
/// Base: gen15_window_350 (+6.38% TEST)
/// Hypothesis: Increase base attention weight (0.24 vs 0.23)
...
impl EvictionScorer for Evolved {
    fn score(&self, token: &TokenInfo) -> f64 {
        ...
        // Stronger attention base weight
        let recent_weight = 0.24 - 0.05 * layer_ratio;
