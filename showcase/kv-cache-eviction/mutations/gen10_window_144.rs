...
/// Gen10: Try recency 35% with window 144
/// Base: gen9_recency_35 (+2.65% over hybrid)
/// Hypothesis: Slightly larger window may synergize with higher recency
...
impl EvictionScorer for Evolved {
    fn score(&self, token: &TokenInfo) -> f64 {
        ...
        // 35% recency with window 144
        let recency_window = 144;
