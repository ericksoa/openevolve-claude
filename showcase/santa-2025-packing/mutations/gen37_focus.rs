//! Evolved Packing Algorithm - Generation 37 FOCUSED STRATEGIES
//!
//! MUTATION STRATEGY: Reduce to 3 best strategies, more SA iterations.
//!
//! Changes from Gen28:
//! - Only use 3 strategies: ClockwiseSpiral, Grid, BoundaryFirst
//! - More SA iterations per strategy (40000 vs 28000)
//! - Focus compute time on what works
...
pub enum PlacementStrategy { ClockwiseSpiral, Grid, BoundaryFirst }
...
impl Default for EvolvedConfig {
    fn default() -> Self {
        Self {
            ...
            sa_iterations: 40000,         // MORE (was 28000)
            ...
            sa_passes: 2,
            early_exit_threshold: 3000,   // Higher (was 2500)
            boundary_focus_prob: 0.85,
            num_strategies: 3,            // FEWER (was 5)
            density_grid_resolution: 20,
            gap_penalty_weight: 0.15,
            local_density_radius: 0.5,
            fill_move_prob: 0.15,
            hot_restart_interval: 1000,   // More restarts (was 800)
...
impl EvolvedPacker {
    ...
    fn local_search(&self, trees: &mut Vec<PlacedTree>, n: usize, pass: usize, _strategy: PlacementStrategy, rng: &mut impl Rng) {
        ...
        let max_restarts = 5;  // More restarts
