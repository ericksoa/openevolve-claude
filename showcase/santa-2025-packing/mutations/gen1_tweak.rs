//! Evolved Packing Algorithm - Generation 1 Tweak Mutation
//!
...
//!
//! MUTATION: Tweaked numerical parameters
//! - search_attempts: 60 -> 75 (25% increase for more exploration)
//! - sa_iterations: 5000 -> 6500 (30% increase for longer optimization)
//! - sa_initial_temp: 0.35 -> 0.45 (29% increase for broader initial search)
//! - balance_penalty: 0.15 -> 0.12 (20% decrease, less aspect ratio emphasis)
...
impl Default for EvolvedConfig {
    fn default() -> Self {
        // Gen1 Tweak parameters - tweaked from baseline
        Self {
            search_attempts: 75,        // TWEAKED: 60 -> 75 (+25%)
            direction_samples: 16,
            sa_iterations: 6500,        // TWEAKED: 5000 -> 6500 (+30%)
            sa_initial_temp: 0.45,      // TWEAKED: 0.35 -> 0.45 (+29%)
