//! Evolved Packing Algorithm - Generation 75d MORE WAVE COMPACTION
//!
//! MUTATION STRATEGY: INCREASE WAVE COMPACTION PASSES
//! Gen73c showed that late-stage continuous angles help (88.90).
//! Hypothesis: Increasing wave compaction passes from 3 to 5 for
//! more outside-in compression opportunities.
//!
//! Risk: More trees with fine angles = more computation + potential SA instability
//!
//! Changes from Gen73c:
//! - Change wave_passes from 3 to 5
