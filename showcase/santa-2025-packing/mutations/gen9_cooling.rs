//! Evolved Packing Algorithm - Generation 9 COOLING RATE TWEAK
//!
...
//!
//! MUTATION STRATEGY: COOLING RATE TWEAK (Gen9)
//! Experiment with SA cooling parameters for better convergence:
//!
//! Key changes from Gen6:
//! - sa_cooling_rate: 0.99997 (slower than Gen6's 0.99994)
//! - sa_initial_temp: 0.50 (slightly higher than Gen6's 0.45)
//! - sa_min_temp: 0.000005 (lower minimum than Gen6's 0.000008)
//! - early_exit_threshold: 2200 (more patience than Gen6's 1800)
//! - All other parameters unchanged from Gen6
//!
//! Target: Beat Gen6's 94.14 at n=200 with optimized cooling schedule
...
impl Default for EvolvedConfig {
    fn default() -> Self {
        // Gen9 COOLING RATE TWEAK: Optimized SA cooling schedule
        Self {
            search_attempts: 280,            // Same as Gen6
            direction_samples: 72,           // Same as Gen6
            sa_iterations: 28000,            // Same as Gen6
            sa_initial_temp: 0.50,           // CHANGED: Higher than Gen6's 0.45
            sa_cooling_rate: 0.99997,        // CHANGED: Slower than Gen6's 0.99994
            sa_min_temp: 0.000005,           // CHANGED: Lower than Gen6's 0.000008
            ...
            early_exit_threshold: 2200,      // CHANGED: More patience than Gen6's 1800
            boundary_focus_prob: 0.85,       // Same as Gen6
            // DENSITY parameters (same as Gen6)
            density_grid_resolution: 20,     // Same as Gen6
            gap_penalty_weight: 0.15,        // Same as Gen6
            local_density_radius: 0.5,       // Same as Gen6
            fill_move_prob: 0.15,            // Same as Gen6
        }
    }
}
