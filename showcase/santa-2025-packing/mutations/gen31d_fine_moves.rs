//! Evolved Packing Algorithm - Generation 31D FINE MOVES
//!
//! MUTATION STRATEGY: Smaller, finer moves for better local optimization.
//!
//! Changes from Gen28:
//! - translation_scale: 0.04 (was 0.055)
//! - boundary_focus_prob: 0.90 (was 0.85)
//! - fill_move_prob: 0.20 (was 0.15)
