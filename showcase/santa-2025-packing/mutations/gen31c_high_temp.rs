//! Evolved Packing Algorithm - Generation 31C HIGH TEMP
//!
//! MUTATION STRATEGY: Higher initial temperature for more exploration.
//!
//! Changes from Gen28:
//! - sa_initial_temp: 0.6 (was 0.45)
//! - hot_restart_temp: 0.45 (was 0.35)
//! - This gives more exploration at the start
...
impl Default for EvolvedConfig {
    fn default() -> Self {
        Self {
            ...
            sa_iterations: 30000,
            sa_initial_temp: 0.60,        // HIGHER (was 0.45)
            ...
            hot_restart_temp: 0.45,       // HIGHER (was 0.35)
            elite_pool_size: 3,
        }
    }
}
