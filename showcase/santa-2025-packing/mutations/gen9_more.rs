//! Evolved Packing Algorithm - Generation 9 MORE COMPUTE
//!
...
//!
//! MUTATION STRATEGY: MORE COMPUTE (Gen9)
//! Gen6 density maximization works well. Apply 10% more computation:
//! - sa_iterations: 32000 (up from 28000)
//! - search_attempts: 320 (up from 280)
//! - direction_samples: 80 (up from 72)
//! All other parameters kept exactly the same as Gen6.
//!
//! Target: Beat Gen6's 94.14 at n=200 with more compute budget
...
impl Default for EvolvedConfig {
    fn default() -> Self {
        // Gen9 MORE COMPUTE: 10% more computation budget
        Self {
            search_attempts: 320,            // +10% from 280 - more attempts for gap-filling
            direction_samples: 80,           // +10% from 72 - more directions for coverage
            sa_iterations: 32000,            // +14% from 28000 - more SA iterations
