//! Evolved Packing Algorithm - Generation 30D ELITE POOL
//!
//! MUTATION STRATEGY: Larger elite pool and more restarts for better exploration.
//!
//! Changes from Gen28:
//! - elite_pool_size: 5 (was 3)
//! - hot_restart_interval: 600 (was 800)
//! - max_restarts: 6 (was 4)
//! - hot_restart_temp: 0.40 (was 0.35)
...
impl Default for EvolvedConfig {
    fn default() -> Self {
        Self {
            ...
            fill_move_prob: 0.15,
            hot_restart_interval: 600,    // MORE FREQUENT (was 800)
            hot_restart_temp: 0.40,       // SLIGHTLY HIGHER (was 0.35)
            elite_pool_size: 5,           // LARGER POOL (was 3)
        }
    }
}
