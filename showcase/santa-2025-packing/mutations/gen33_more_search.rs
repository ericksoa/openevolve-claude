//! Evolved Packing Algorithm - Generation 33 MORE SEARCH
//!
//! MUTATION STRATEGY: More search attempts for better initial placements.
//!
//! Changes from Gen28:
//! - search_attempts: 300 (was 200)
//! - This should find better initial placements before SA optimization
...
impl Default for EvolvedConfig {
    fn default() -> Self {
        Self {
            search_attempts: 300,         // MORE (was 200)
