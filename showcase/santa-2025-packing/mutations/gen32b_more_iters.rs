//! Evolved Packing Algorithm - Generation 32B MORE ITERATIONS
//!
//! MUTATION STRATEGY: More SA iterations for deeper optimization.
//!
//! Changes from Gen28:
//! - sa_iterations: 35000 (was 28000)
//! - More time per tree to find better configurations
...
impl Default for EvolvedConfig {
    fn default() -> Self {
        Self {
            ...
            sa_iterations: 35000,         // MORE (was 28000)
