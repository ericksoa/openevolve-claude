//! Evolved Packing Algorithm - Generation 75a EXTEND TO LAST 40%
//!
//! MUTATION STRATEGY: EXTEND FINE ANGLES TO LAST 40% OF TREES
//! Gen73c showed that late-stage continuous angles help (88.90).
//! Hypothesis: Extending fine angles to n >= 120 (last 40%) instead of
//! n >= 140 (last 30%) might help more trees fit into gaps.
//!
//! Risk: More trees with fine angles = more computation + potential SA instability
//!
//! Changes from Gen73c:
//! - Change late_stage_threshold from 140 to 120
...
impl Default for EvolvedConfig {
    fn default() -> Self {
        Self {
            ...
            wave_passes: 3,
            late_stage_threshold: 120,  // CHANGED: was 140, now 120 (last 40%)
