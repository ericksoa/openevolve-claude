//! Evolved Packing Algorithm - Generation 31B SLOW COOLING
//!
//! MUTATION STRATEGY: Slower cooling rate for longer exploitation.
//!
//! Changes from Gen28:
//! - sa_cooling_rate: 0.99996 (was 0.99993)
//! - sa_iterations: 40000 (was 30000)
//! - This allows more time at each temperature level
...
impl Default for EvolvedConfig {
    fn default() -> Self {
        Self {
            ...
            sa_iterations: 40000,         // MORE ITERATIONS (was 30000)
            sa_initial_temp: 0.45,
            sa_cooling_rate: 0.99996,     // SLOWER COOLING (was 0.99993)
            sa_min_temp: 0.00001,
            translation_scale: 0.055,
            rotation_granularity: 45.0,
            center_pull_strength: 0.07,
            sa_passes: 2,
            early_exit_threshold: 3000,   // HIGHER EXIT (was 2500)
            ...
            fill_move_prob: 0.15,
            hot_restart_interval: 1000,   // LESS FREQUENT (was 800)
