//! Evolved Packing Algorithm - Generation 65 MORE ITERATIONS
//!
//! MUTATION STRATEGY: INCREASED SA SEARCH TIME
//! Give the optimizer more time to find better solutions.
//!
//! Changes from Gen62:
//! - Increase SA iterations from 28000 to 40000
//! - Increase SA passes from 2 to 3
//! - Slightly slower cooling for more gradual annealing
//!
//! Target: Better solutions through more thorough search
...
impl Default for EvolvedConfig {
    fn default() -> Self {
        Self {
            ...
            sa_iterations: 40000,       // Gen65: increased from 28000
            sa_initial_temp: 0.45,
            sa_cooling_rate: 0.99995,   // Gen65: slower cooling
            sa_min_temp: 0.00001,
            translation_scale: 0.055,
            rotation_granularity: 45.0,
            center_pull_strength: 0.07,
            sa_passes: 3,               // Gen65: increased from 2
