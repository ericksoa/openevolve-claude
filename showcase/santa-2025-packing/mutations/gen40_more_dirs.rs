//! Evolved Packing Algorithm - Generation 40 MORE DIRECTIONS
//!
//! MUTATION STRATEGY: More direction sampling during initial placement.
//!
//! Changes from Gen28:
//! - direction_samples: 128 (was 64)
//! - search_attempts: 250 (was 200)
//! - Better initial placements should lead to better final results
...
impl Default for EvolvedConfig {
    fn default() -> Self {
        Self {
            search_attempts: 250,         // MORE (was 200)
            direction_samples: 128,       // MORE (was 64)
            sa_iterations: 28000,
...
impl EvolvedPacker {
    ...
    fn select_direction_for_strategy(&self, n: usize, width: f64, height: f64, strategy: PlacementStrategy, attempt: usize, rng: &mut impl Rng) -> f64 {
        match strategy {
            ...
            PlacementStrategy::Grid => (attempt % 32) as f64 / 32.0 * 2.0 * PI + rng.gen_range(-0.02..0.02),  // More directions
            PlacementStrategy::Random => {
