//! Evolved Packing Algorithm - Generation 9 BOUNDARY TUNING
//!
...
//!
//! MUTATION STRATEGY: BOUNDARY TUNING (Gen9)
//! Fine-tune boundary focus parameters for tighter packing:
//!
//! Key improvements from Gen6:
//! - boundary_focus_prob: 0.92 (up from 0.85) - more boundary focus
//! - center_pull_strength: 0.09 (up from 0.07) - stronger compaction
//! - translation_scale: 0.045 (down from 0.055) - finer movements
//! - All other density-aware features preserved
//!
//! Target: Beat Gen6's 94.14 at n=200 with tighter boundary control
...
impl Default for EvolvedConfig {
    fn default() -> Self {
        // Gen9 BOUNDARY TUNING: Tighter boundary control configuration
        Self {
            search_attempts: 280,            // Keep from Gen6
            direction_samples: 72,           // Keep from Gen6
            sa_iterations: 28000,            // Keep from Gen6
            sa_initial_temp: 0.45,           // Keep from Gen6
            sa_cooling_rate: 0.99994,        // Keep from Gen6
            sa_min_temp: 0.000008,           // Keep from Gen6
            translation_scale: 0.045,        // TUNED: down from 0.055 for finer movements
            rotation_granularity: 45.0,      // Keep 8 angles
            center_pull_strength: 0.09,      // TUNED: up from 0.07 for stronger compaction
            sa_passes: 2,                    // Keep 2 passes
            early_exit_threshold: 1800,      // Keep from Gen6
            boundary_focus_prob: 0.92,       // TUNED: up from 0.85 for more boundary focus
